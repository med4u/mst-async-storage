import { getType, flow, applySnapshot, getSnapshot, onSnapshot } from 'mobx-state-tree';
...
var withAsyncStorage = function (options) {
    ...
    return function (self) {
        var disposer;
        var key = options.key || getType(self).name;
        ...
        var enableSaving = function () {
            disposer && disposer();
            disposer = onSnapshot(self, function (snapshot) { return save(key, filterSnapshotKeys(snapshot), Password); });
        };
        ...
        return {
            actions: {
                ...
                save: flow(function () {
                    return __generator$1(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, save(key, filterSnapshotKeys(getSnapshot(self)), Password)];
                            case 1:
                                _a.sent();
                                return [2];
                        }
...
export { withAsyncStorage };
//# sourceMappingURL=mst-async-storage.es5.js.map
